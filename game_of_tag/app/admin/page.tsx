...
const InputField = (props: any) => (
  <input 
    {...props}
    className="w-full bg-slate-950/50 border border-slate-700 text-white p-2.5 rounded-lg focus:outline-none focus:border-pink-500 focus:ring-1 focus:ring-pink-500 transition-all placeholder-slate-600"
  />
);
...
const SelectField = (props: any) => (
  <select 
    {...props}
    className="w-full bg-slate-950/50 border border-slate-700 text-white p-2.5 rounded-lg focus:outline-none focus:border-pink-500 focus:ring-1 focus:ring-pink-500 transition-all"
  />
);
...
export default function AdminPage() {
  ...
  const getLogColor = (id: number) => {
    switch(id) {
      ...
      case LOG_TYPE_CATCH: return "text-pink-500 font-bold drop-shadow-[0_0_5px_rgba(236,72,153,0.5)]";
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-slate-200 p-2 md:p-8 font-sans relative overflow-x-hidden">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-8 backdrop-blur-sm bg-black/20 p-6 rounded-2xl border border-white/5">
        ...
        <div className="flex gap-4 items-center">
          ...
          {loading && <span className="text-pink-500 animate-pulse text-xs font-bold uppercase">Synchronizace...</span>}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
           {['red', 'blue', 'green'].map(team => {
             ...
             // Hlavní skóre z tabulky player
             const realScore = realScores[teamKey];
             // Kontrolní skóre z logů
          ...
          <div className="p-6">
              ...
              <div className="animate-in fade-in zoom-in-95 duration-300">
                ...
                <div className="grid grid-cols-1 gap-3">
                  {playersList.map(p => {
                     ...
                     return (
                      <div key={p.idPlayer} className="bg-black/20 rounded-xl border border-white/5 hover:border-purple-500/30 transition-all group">
            ...
            {activeTab === 'checkpoints' && (
               <div className="animate-in fade-in zoom-in-95 duration-300">
                ...
                {/* EDIT FORM - NEW CP */}
                {editingId === 'new' && (
                  <div className="mb-8 bg-slate-800/50 backdrop-blur border border-pink-500/30 p-6 rounded-2xl shadow-[0_0_30px_rgba(236,72,153,0.1)]">
                ...
                <div className="grid grid-cols-1 gap-3">
                  {checkpointsList.map(cp => {
                     ...
                     return (
                      <div key={cp.idLocation} className="bg-black/20 rounded-xl border border-white/5 hover:border-pink-500/30 transition-all group">
