// // --- VERSION 3 - ZOBRAZENÍ CHECKPOINTU PO NAČTENÍ POLOHY ---
// "use client";

// import { ReactNode, useState } from "react";
// import { useRouter } from "next/navigation";
// import { findNearestCheckpoint, verifyPlayer, checkActiveQuest } from "@/src/actions/loadLocation"; // Přidal jsem checkActiveQuest
// import { Header } from "@/src/components/Header";
// import { Footer } from "@/src/components/Footer";
// import { CHECKPOINT_RADIUS_METERS, GPS_TIMEOUT_MS } from '../../src/constants';
// import Link from "next/link";
// import CheckpointForm from "@/src/components/CheckpointForm"; // <--- DŮLEŽITÝ IMPORT

// // Stavy pro GPS
// type LocationState = "idle" | "loading" | "error" | "found" | "not_in_range";
// // Stavy pro přepínání obrazovek
...
//   // Řízení obrazovky (Login -> GPS -> Quest)
...
//         // Pokud chyba znamená ztrátu autorizace (ban, špatné heslo)
...
//         // Nastavíme timeout 3 sekundy
//         setTimeout(() => {
//             setActiveQuestCode(result.checkpoint.code);
//             // Přepneme celou obrazovku na QUEST mód
//             setViewMode("quest");
//         }, 3000); 
...
//           {/* Nadpis zobrazujeme jen když nejsme v questu */}
//           {viewMode !== "quest" && (
//             <div>
...
//                            <b>{nearestCheckpoint.code}</b> ({nearestCheckpoint.distanceMeters} m)
//                          </p>
//                          <p className="text-gray-light text-sm animate-pulse">Otevírám úkol...</p>
//                        </div>
//                      )}
