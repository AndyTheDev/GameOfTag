  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4 text-center relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-lg mx-auto">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-500">
          Work in Progress
        </h1>
        <p className="text-lg text-slate-400 mt-6 mb-8 leading-relaxed">
